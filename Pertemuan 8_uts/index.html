...
<head>
  ...
  <title>Welcome — Kedai RR</title>
  <script src="https://cdn.tailwindcss.com"></script>
  <!-- Google Fonts -->
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;600;800&display=swap" rel="stylesheet">
  <style>
    body { font-family: 'Poppins', sans-serif !important; }
    .fade-in { opacity: 0; transform: translateY(20px); transition: all 1.2s ease; }
    ...
    .logo-glow { text-shadow: 0 0 10px rgba(34,197,94,0.7), 0 0 20px rgba(34,197,94,0.5); }
    .shine { animation: shine 3s ease-in-out infinite alternate; }
    @keyframes shine {
      from { opacity: 0.5; }
      to { opacity: 1; }
    }
...
<body class="antialiased">
  ...
  <!-- WELCOME SECTION -->
  <section class="relative h-screen w-full bg-cover bg-center" style="background-image: url('images/kedai.jpeg');"
>
  ...
  <script>
    ...
    window.addEventListener('load', () => {
      setTimeout(() => fadeEl.classList.add('show'), 400);
    });
  </script>
