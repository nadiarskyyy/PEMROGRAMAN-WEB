...
<head>
  ...
  <title>Kedai RR — About</title>
  <script src="https://cdn.tailwindcss.com"></script>
  <!-- Font Awesome untuk ikon sosmed -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
  <style>
    body {
      background-image: url('images/bg.jpg'); /* ganti sesuai lokasi gambar */
      background-size: cover;
      background-position: center;
      background-repeat: no-repeat;
      background-attachment: fixed;
      position: relative;
      color: #1F2937; /* default teks */
    }
    ...
    body::before {
      ...
      width: 100%;
      height: 100%;
      background: rgba(255, 255, 255, 0.2); /* overlay transparan */
      z-index: -1;
    }

    .fade-up { opacity: 0; transform: translateY(20px); transition: all .6s ease-in-out; }
...
<body class="text-gray-800 antialiased">
  ...
  <header class="sticky top-0 z-40 bg-white/80 backdrop-blur-md shadow-sm">
    <div class="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
      <div class="flex items-center justify-between h-16">
        ...
        <nav class="hidden md:flex items-center gap-6">
          ...
          <a href="index.html#products" class="hover:text-green-600">Products</a>
          <a href="#about" class="hover:text-green-600 font-semibold">About</a>
        </nav>
    ...
    <div id="mobileNav" class="md:hidden hidden border-t bg-white">
      <div class="px-4 py-3 flex flex-col">
        ...
        <a href="#about" class="py-2 font-semibold">About</a>
      </div>
    </div>
  </header>
  ...
  <section id="about" class="py-20">
    <div class="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
      <div class="fade-up">
        ...
        <a href="index.html#home" class="inline-block bg-green-600 text-white px-5 py-3 rounded-lg shadow hover:bg-green-700 transition">
          BACK
        </a>
      </div>
  ...
  <footer class="bg-green-700 text-white py-6">
    <div class="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
      <div class="font-semibold">© <span id="year"></span> Kedai RR</div>
      <div class="text-sm">Contact: 0838-5437-0187</div>
      <div class="flex gap-4 text-xl">
        <a aria-label="Facebook" href="https://www.facebook.com/username" target="_blank" class="hover:text-yellow-300">
          <i class="fab fa-facebook"></i>
        </a>
        <a aria-label="Instagram" href="https://www.instagram.com/ndyarsky__?igsh=anBjbG1wdXhvMHR5" target="_blank" class="hover:text-yellow-300">
          <i class="fab fa-instagram"></i>
        </a>
        <a aria-label="WhatsApp" href="https://web.whatsapp.com/" target="_blank" class="hover:text-yellow-300">
